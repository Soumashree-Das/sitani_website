...
//                 <button className="bg-amber-500 hover:bg-amber-600 text-stone-900 font-bold py-4 px-8 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg">
//                   Get Free Quote
//                 </button>
//                 <button className="border-2 border-white hover:bg-white hover:text-stone-900 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300">
//                   View Our Work
//                 </button>
//               </div>
//             </div>
