...
// import { Link, useNavigate } from "react-router-dom"; // Added missing import
...
//       // Use the correct port (8000) and fix the spelling
//       const response = await fetch(
...
//       } else if (result.data) {
//         // If the API returns { success, data, message } format
...
//           onCanPlayThrough={() => {
//             // Optional: handle logic when video is ready
//             console.log("Video ready to play without buffering");
//           }}
//         />
...
//             With over 70 years of legacy in excellence and innovation, we build
